...
async function main() {
    groq.chat.completions.create({
        ...
        messages: [
            ...
            {
                role: "system",
                content: "Génère Une documentation sur : let dreamSystem = new dreamSystem(content);."
            },
            {
                role: "assistant",
